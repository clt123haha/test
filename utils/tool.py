...
#存储图片
def generate_captcha_image(save_path=r'D:\exchange\Temp\image'):
...
#判断验证码是否正确以及删除过期验证码
def check_Indonesia(indonesia,path=r'D:\exchange\Temp\image'):   # 退出程序的时候一定要记得删除验证码，否则内存占用会越来越大
